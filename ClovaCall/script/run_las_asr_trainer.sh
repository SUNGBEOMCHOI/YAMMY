...
TRAIN_FILE=../data/aihub_car/scripts/train.json
# TEST_FILE=data/ClovaCall/test_ClovaCall.json
TEST_FILE=../data/aihub_car/scripts/validation.json
# TEST_FILE=data/aihub_car/scripts/test.json
LABEL_FILE=data/kor_syllable.json
# DATASET_PATH=data/ClovaCall/clean
DATASET_PATH=../data/aihub_car/data
...
--cuda --load-model --finetune --save-folder $CUR_MODEL_PATH --model-path $CUR_MODEL_PATH/final.pth --log-path $LOG_CHILD_PATH | tee $LOG_FILE 
