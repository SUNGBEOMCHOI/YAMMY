...
def main():
    ...
    trainData_list = []
    with open(args.train_file, 'r', encoding='utf-8-sig') as f:
    ...
    for test_file in args.test_file_list:
        ...
        test_dataset = SpectrogramDataset(audio_conf=audio_conf,
                                          ...
                                          char2index=char2index, sos_id=SOS_token, eos_id=EOS_token,
                                          normalize=True)
        testLoader_dict[test_file] = AudioDataLoader(test_dataset, batch_size=16, num_workers=args.num_workers)
    ...
    if args.mode != "train":
        for test_file in args.test_file_list:
            ...
            with open('./aihub_car_clean_validation.txt', 'w', encoding='utf-8-sig') as f:
