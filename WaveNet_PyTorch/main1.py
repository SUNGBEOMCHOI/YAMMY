...
def get_arguments():
    ...
    config='/root/test/WaveNet_PyTorch/data/wavenet/config.json'
    mode='inference'
    load_checkpoint='/root/test/WaveNet_PyTorch/data/NSDTSEA/checkpoints/config1_epoch0097.pth'
    condition_value=0
    batch_size=4
    one_shot=False
    clean_input_path='/root/test/WaveNet_PyTorch/data/NSDTSEA/clean_speech'
    noisy_input_path='/root/test/WaveNet_PyTorch/data/NSDTSEA/noisy_speech'
